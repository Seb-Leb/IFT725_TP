...
class TwoLayerNeuralNet(object):
    ...
    def loss(self, X, y=None):
        ...
        ############################################################################
        H1, cache1 = forward_fully_connected_transform_relu(X, self.params['W1'], self.params['b1'])
        scores, cache2 = forward_fully_connected(H1, self.params['W2'], self.params['b2'])
        ############################################################################
        #                             FIN DE VOTRE CODE                            #
        ############################################################################
        ...
        loss += self.reg * np.linalg.norm(self.params['W1'])**2
